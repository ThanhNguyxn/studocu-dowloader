...
**✨ Bypass blur & watermark • 📄 Selectable text • 🚀 Auto-scroll & one-click download**
...
| Feature | Description |
|:--------|:------------|
| 🔓 **Bypass Blur** | Remove blur overlay and watermark instantly |
| 📜 **Auto-Scroll** | Automatically loads all pages for you |
| 📄 **PDF Export** | Export with selectable text (copy/paste works!) |
| 🎨 **Clean Output** | No artifacts, proper formatting |
...
Navigate to any document on `studocu.com`

### 2️⃣ Click Extension Icon
Click the StudoCu Downloader icon in your toolbar

### 3️⃣ Bypass Blur (if needed)
If content is blurred, click **"🔓 Bypass Blur"** first
...
| Problem | Solution |
|:--------|:---------|
| No pages found | Let the extension auto-scroll, or scroll manually first |
| Blur still visible | Use Incognito/Private mode |
